"""
Main LPWM training function for multi-GPU machines.
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if epoch % eval_epoch_freq == 0 or epoch == num_epochs - 1:
            ...
            if eval_im_metrics and epoch > 0:
                valid_imm_results = eval_lpwm_im_metric(unwrapped_model, accelerator.device, config,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="LPWM Multi-GPU Training")
